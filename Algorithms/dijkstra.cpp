...
{
	int index,d,parent;														//parent in shortest path tree
}vertex;
...
vertex* dijkstra(vector<vector<int> > graph, int **weight, int s);
...
int main()
{
	...
	s = 0;
	V = dijkstra(graph, weight, s);
	for(i=0;i<n;i++) cout<<V[i].d<<endl;
	return 0;
}
