...
#define MAX 6
// Run Kirchhoff Matrix Tree algorithm on complete ecludian graph
// to find the maximum number of spanner tree and then find a minimum
// prime greater than that as a MOD. This is to avoid using double
// and division in determinant calculation.
